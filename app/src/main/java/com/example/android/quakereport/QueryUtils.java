...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            JSONArray featuresArray = query.getJSONArray("features");
            for (int i = 0; i < featuresArray.length(); ++i) {
                ...
                earthquakes.add(new Earthquake(mag, place, timestamp, detailsUrl));
            }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem retrieving JSON information. ", e);
        } finally {
